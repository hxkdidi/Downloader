...
public class CircleProgressView extends ProgressBar {
    ...
    private int mReachBarSize = DisplayUtils.dp2px(2); // 未完成进度条大小
    private int mNormalBarSize = DisplayUtils.dp2px(2); // 未完成进度条大小
    private int mReachBarColor = ContextCompat.getColor(getContext(), R.color.colorPrimaryDark); // 已完成进度颜色
    private int mNormalBarColor = ContextCompat.getColor(getContext(), R.color.colorPrimary); // 未完成进度颜色
    private int mTextSize = DisplayUtils.sp2px(12); // 进度值字体大小
    private int mTextColor = ContextCompat.getColor(getContext(), R.color.colorPrimary); // 进度的值字体颜色
    ...
    private int mOuterSize = DisplayUtils.dp2px(1); // 外层圆环宽度
    ...
    public void setRadius(int radius) {
        mRadius = DisplayUtils.dp2px(radius);
        invalidate();
    }
    ...
    public void setInnerPadding(int innerPadding) {
        mInnerPadding = DisplayUtils.dp2px(innerPadding);
        int mInnerRadius = mRadius - mOuterSize / 2 - mInnerPadding;
        rectInner = new RectF(-mInnerRadius, -mInnerRadius, mInnerRadius, mInnerRadius);
        invalidate();
    }
    ...
    public void setOuterSize(int outerSize) {
        mOuterSize = DisplayUtils.dp2px(outerSize);
        invalidate();
    }
